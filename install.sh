...
echo "deb [signed-by=/usr/share/keyrings/ambct.gpg] https://raw.githubusercontent.com/BlitzPythoner/AMBCT-Repo/main/ ./" | sudo tee /etc/apt/sources.list.d/ambct.list
